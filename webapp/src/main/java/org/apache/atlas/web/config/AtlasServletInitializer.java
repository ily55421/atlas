...
/**
 * Servlet context initializer for Atlas.
 * Configures session cookie settings.
 */
@Configuration
public class AtlasServletInitializer implements ServletContextInitializer {

    @Override
    public void onStartup(ServletContext servletContext) throws ServletException {
        // Set session tracking mode to COOKIE only
